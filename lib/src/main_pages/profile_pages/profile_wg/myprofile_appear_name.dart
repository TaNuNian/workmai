...
class MyprofileAppearName extends StatefulWidget {
  ...
  const MyprofileAppearName({super.key, required this.username});
        ...
        Consumer<UserProvider>(
          builder: (context, userProvider, child) {
            if (userProvider.userData == null) {
              return const Center(child: Text('ERROR', style: TextStyle(color: Colors.red, fontWeight: FontWeight.w900, fontSize: 20),));
            }
            else {
              final displayName =
                  userProvider.userData!["profile"]["display_name"];
